...
(function() {
  var Browser, ClickOnlyButton, ControlPanel, ControlPanelModel, PhotomosaicViewer, Point, Popup, Pyramid, SearchPanel, SearchResult, Shadow, Tile, TileView, Tiles, Timeline, TimelineChild, TimelineChildView, Utility, arrZoomSizeX, arrZoomSizeY, blockHeight, blockWidth, i, maxSearchResultNum, minBlockSize, minZoom, motifHeight, motifWidth, nowZoom, pinchTrigger, pinchTriggerArray, prevZoom, searchPhp, tileHeight, tileImageDir, tileImageExtension, tileWidth, z, zoomImageDir, zoomSize, _i, _len, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
  ...
  */
  ...
  SearchPanel = (function(_super) {
    ...
    function SearchPanel() {
      ...
      this.bottom = __bind(this.bottom, this);      _ref1 = SearchPanel.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
    ...
    SearchPanel.prototype.onclicktimeline = function(d) {
      return console.log("onclicktimeline", d);
    };
    ...
    SearchPanel.hide = function() {
      ...
      SearchPanel.timeline.each(SearchPanel.clear);
      Shadow.hide();
      return $(SearchPanel.el).hide();
    };

    SearchPanel.prototype.clear = function(tl) {
      return tl.clear();
    };
  ...
  Timeline = (function(_super) {
    ...
    function Timeline() {
      _ref2 = Timeline.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
  ...
  TimelineChild = (function(_super) {
    ...
    function TimelineChild() {
      _ref3 = TimelineChild.__super__.constructor.apply(this, arguments);
      return _ref3;
    }
  ...
  TimelineChildView = (function(_super) {
    ...
    TimelineChildView.prototype.render = function() {
      ...
      $('<img />').attr('class', 'tlImg').attr('width', 80).attr('src', 'swfData/blockimg/' + item.img + '.jpg').load().appendTo(tl);
  ...
  SearchResult = (function(_super) {
    ...
    function SearchResult() {
      ...
      this.sendQuery = __bind(this.sendQuery, this);      _ref5 = SearchResult.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
  ...
  */
  ...
  Browser = (function(_super) {
    ...
    function Browser() {
      _ref6 = Browser.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
  ...
  Utility = (function() {
    ...
    Utility.type = (function() {
      var classToType, name, _j, _len1, _ref7;

      classToType = {};
      _ref7 = "Boolean Number String Function Array Date RegExp Undefined Null".split(" ");
  ...
  */
  ...
  Pyramid = (function(_super) {
    ...
    function Pyramid() {
      _ref7 = Pyramid.__super__.constructor.apply(this, arguments);
      return _ref7;
    }
    ...
    */
    ...
    Pyramid.prototype.onMouseDown = function(e) {
      ...
      if (Utility.type(cords[0]) !== 'array') {
        ...
        this.pinchinStartCenterX = (cords[0][0] + cords[1][0]) / 2;
        this.pinchinStartCenterY = (cords[0][1] + cords[1][1]) / 2;
  ...
  */
  ...
  Tile = (function(_super) {
    ...
    function Tile() {
      _ref8 = Tile.__super__.constructor.apply(this, arguments);
      return _ref8;
    }
  ...
  */
  ...
  TileView = (function(_super) {
    ...
    function TileView() {
      this.unrender = __bind(this.unrender, this);
      this.render = __bind(this.render, this);      _ref9 = TileView.__super__.constructor.apply(this, arguments);
      return _ref9;
    }
  ...
  */
  ...
  Tiles = (function(_super) {
    ...
    function Tiles() {
      _ref10 = Tiles.__super__.constructor.apply(this, arguments);
      return _ref10;
    }
  ...
  */
  ...
  ControlPanel = (function(_super) {
    ...
    function ControlPanel() {
      _ref11 = ControlPanel.__super__.constructor.apply(this, arguments);
      return _ref11;
    }
  ...
  ControlPanelModel = (function(_super) {
    ...
    function ControlPanelModel() {
      _ref12 = ControlPanelModel.__super__.constructor.apply(this, arguments);
      return _ref12;
    }
  ...
  */
  ...
  ClickOnlyButton = (function(_super) {
    ...
    function ClickOnlyButton() {
      _ref13 = ClickOnlyButton.__super__.constructor.apply(this, arguments);
      return _ref13;
    }
  ...
  */
  ...
  Point = (function() {
    ...
    Point.getPoint = function(e) {
      var cords, item, _j, _len1, _ref14;
      ...
      if (Point.isTouch()) {
        if (e.originalEvent.touches.length === 1) {
          ...
          console.log("MULTI");
          cords = [];
          _ref14 = e.originalEvent.touches;
  ...
  Shadow = (function(_super) {
    ...
    function Shadow() {
      _ref14 = Shadow.__super__.constructor.apply(this, arguments);
      return _ref14;
    }
  ...
  Popup = (function(_super) {
    ...
    function Popup() {
      _ref15 = Popup.__super__.constructor.apply(this, arguments);
      return _ref15;
    }
