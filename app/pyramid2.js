    ...
    Point.getPoint = function(e) {
      ...
      if (Point.isTouch()) {
        if (e.originalEvent.touches.length === 1) {
          ...
          console.log("MULTI");
          cords = [];
          _ref10 = e.originalEvent.touches;
