...
(function() {
  var Browser, ClickOnlyButton, ControlPanel, ControlPanelModel, PhotomosaicViewer, Point, Popup, Pyramid, SearchPanel, SearchResult, Shadow, Tile, TileView, Tiles, TimelineChild, Utility, arrZoomSizeX, arrZoomSizeY, blockHeight, blockWidth, i, maxSearchResultNum, minBlockSize, minZoom, motifHeight, motifWidth, nowZoom, pinchTrigger, pinchTriggerArray, prevZoom, searchPhp, tileHeight, tileImageDir, tileImageExtension, tileWidth, z, zoomImageDir, zoomSize, _i, _len, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
  ...
  */
  ...
  SearchPanel = (function(_super) {
    ...
    SearchPanel.prototype.render = function(result) {
      var item, tl, tlChild, _j, _len1;

      if (result !== "") {
        for (_j = 0, _len1 = result.length; _j < _len1; _j++) {
          item = result[_j];
          tlChild = new TimelineChild;
          tl = $('<div />').attr('class', 'timelineChild').attr('id', 'timelineChild' + item.id).appendTo($('#searchResult'));
  ...
  TimelineChild = (function(_super) {
    ...
    function TimelineChild() {
      _ref2 = TimelineChild.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
  ...
  SearchResult = (function(_super) {
    ...
    function SearchResult() {
      ...
      this.sendQuery = __bind(this.sendQuery, this);      _ref3 = SearchResult.__super__.constructor.apply(this, arguments);
      return _ref3;
    }
  ...
  */
  ...
  Browser = (function(_super) {
    ...
    function Browser() {
      _ref4 = Browser.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
  ...
  Utility = (function() {
    ...
    Utility.type = (function() {
      var classToType, name, _j, _len1, _ref5;

      classToType = {};
      _ref5 = "Boolean Number String Function Array Date RegExp Undefined Null".split(" ");
  ...
  */
  ...
  Pyramid = (function(_super) {
    ...
    function Pyramid() {
      _ref5 = Pyramid.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
    ...
    */
    ...
    Pyramid.prototype.onMouseUp = function(e) {
      ...
      if (this.dragStartX === cords[0] && this.dragStartY === cords[1] && this.isOnTiles([cords[0], cords[1]])) {
        if (!Shadow.isShow()) {
          return this.trigger('openFromPoint', this.getNumFromPoint([cords[0], cords[1]]));
        }
      } else {
        return this.update();
      }
  ...
  */
  ...
  TileView = (function(_super) {
    ...
    function TileView() {
      ...
      this.render = __bind(this.render, this);      _ref7 = TileView.__super__.constructor.apply(this, arguments);
      return _ref7;
    }
  ...
  */
  ...
  Tiles = (function(_super) {
    ...
    function Tiles() {
      _ref8 = Tiles.__super__.constructor.apply(this, arguments);
      return _ref8;
    }
  ...
  */
  ...
  ControlPanel = (function(_super) {
    ...
    function ControlPanel() {
      _ref9 = ControlPanel.__super__.constructor.apply(this, arguments);
      return _ref9;
    }
  ...
  ControlPanelModel = (function(_super) {
    ...
    function ControlPanelModel() {
      _ref10 = ControlPanelModel.__super__.constructor.apply(this, arguments);
      return _ref10;
    }
  ...
  */
  ...
  ClickOnlyButton = (function(_super) {
    ...
    function ClickOnlyButton() {
      _ref11 = ClickOnlyButton.__super__.constructor.apply(this, arguments);
      return _ref11;
    }
  ...
  */
  ...
  Point = (function() {
    ...
    Point.getPoint = function(e) {
      var cords, item, _j, _len1, _ref12;
      ...
      if (Point.isTouch()) {
        if (e.originalEvent.touches.length === 1) {
          ...
          console.log("MULTI");
          cords = [];
          _ref12 = e.originalEvent.touches;
  ...
  Shadow = (function(_super) {
    ...
    function Shadow() {
      _ref12 = Shadow.__super__.constructor.apply(this, arguments);
      return _ref12;
    }
  ...
  Popup = (function(_super) {
    ...
    function Popup() {
      _ref13 = Popup.__super__.constructor.apply(this, arguments);
      return _ref13;
    }
