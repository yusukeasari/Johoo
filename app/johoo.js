...
(function() {
  var Browser, ClickOnlyButton, ControlPanel, ControlPanelModel, DeleteValueButton, Marker, PhotomosaicViewer, Point, Popup, Pyramid, SEARCH_API, SModel, SearchPanel, SearchResult, Shadow, SmallMap, TIMELINE_API, Tile, TileView, Tiles, Timeline, TimelineChild, TimelineChildView, Utility, arrZoomSizeX, arrZoomSizeY, blockHeight, blockWidth, commentZoom, i, maxSearchResultNum, minBlockSize, minZoom, motifHeight, motifWidth, nowZoom, pinchTrigger, pinchTriggerArray, prevZoom, tileHeight, tileImageDir, tileImageExtension, tileWidth, tlImageWidth, z, zoomImageDir, zoomSize, _i, _len, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
  ...
  SmallMap = (function(_super) {
    ...
    SmallMap.prototype.initialize = function(_el, _url) {
      ...
      $(this.el).css({
        ...
        'background-size': zoomSize[1][0] / this.m
      });
  ...
  */
  ...
  Utility = (function() {
    ...
    Utility.type = (function() {
      var classToType, name, _j, _len1, _ref10;
  ...
  */
  ...
  Point = (function() {
    ...
    Point.getPoint = function(e) {
      var cords, item, _j, _len1, _ref18;
